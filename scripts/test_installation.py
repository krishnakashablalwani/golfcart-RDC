...
def main():
    ...
    if total_pass == total_tests:
        ...
        print("3. Register faces: python register_face_deepface.py")
        print("4. Run recognition: python recognize_face_deepface.py")
    elif results['MongoDB'] == False:
        print("MongoDB not running (optional for testing)")
        print("\nYou can still test:")
        print("- Camera: python register_face_deepface.py")
